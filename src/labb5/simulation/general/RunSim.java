 ...
 */
	...
	/**
	 * Runs the simulation. Individual events affect the state of the simulation according to  given parameters in runSim() as well as rules for how the events behave(described in said events)
	 * Changes may be observed if one adds a view to the implementation.
	 * 
	 * @param closingTime Time at which a simulation is meant to close its generic doors so to speak,NOT to stop the simulation entirely.
	 */
