...
public class FIFO {
	...
	/*
	 *  Adds a new event representing the future payment and 
	 *  subsequent exit of a customer to the queue.
	 */
	public void add() {
		shopQueue.add(PayLeaveEvent);
	}
	/*
	 * Represents the customer finally paying and leaving 
	 * both the queue and the supermarket.
	 *  
	 *  @return PayLeaveEvent  if there is a customer able to pay and leave,
	 *  the method returns said event. Elsewise it returns null.
	 */
	...
	/*
	 *  Outputs String to represent the queues size and
	 *  which customers are present in it.
	 *   
